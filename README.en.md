...
- The callback path is configurable (default `/notify/bepusdt`), stored in the database, and **changes take effect immediately** via a dynamic fallback route (no restart needed);
