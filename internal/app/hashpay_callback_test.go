...
func newHashPayCallbackServer(t *testing.T) (*Server, *sql.DB, *settingssqlite.Store, string) {
	t.Helper()
...
func TestHashPayCallbackBadEnvelope(t *testing.T) {
	...
	orderNo := fixtures.SeedOrder(t, d, pid, orderdomain.OrderWaitingPayment, "HP3")
