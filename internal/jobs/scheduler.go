...
func (s *Scheduler) Add(name string, interval time.Duration, runOnStart bool, run func() error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *Scheduler) runOnce(name string, run func() error) {
