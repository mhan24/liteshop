<template>
  <el-card v-loading="loading">
    ...
    <el-form ref="formRef" :model="form" label-position="top" style="max-width:560px">
      ...
      <el-row :gutter="12">
        <el-col :md="8">
          <el-form-item :label="t('products.minQty')"><el-input-number v-model="form.min_qty" :min="1" style="width:100%" /></el-form-item>
        </el-col>
        <el-col :md="8">
          <el-form-item :label="t('products.maxQty')"><el-input-number v-model="form.max_qty" :min="1" style="width:100%" /></el-form-item>
        </el-col>
        <el-col :md="8">
          <el-form-item :label="t('products.cost')"><el-input-number v-model="form.cost" :min="0" :precision="2" style="width:100%" /></el-form-item>
        </el-col>
      </el-row>
      <el-form-item :label="t('products.wholesale')">
        <div style="width:100%">
          <div v-for="(tier, idx) in form.wholesale" :key="idx" class="wholesale-row">
            <el-input-number v-model="tier.min_qty" :min="2" :placeholder="t('products.wholesaleMinQty')" style="width:120px" />
            <el-input-number v-model="tier.discount" :min="1" :max="99" :placeholder="t('products.wholesaleDiscount')" style="width:120px" />
