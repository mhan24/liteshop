<template>
  <el-container class="admin-layout">
    <el-aside :width="collapsed ? '64px' : '220px'" class="side">
      ...
      <el-menu :collapse="collapsed" :default-active="activeMenu" router background-color="#1f2329" text-color="#cfd3dc" active-text-color="#ffffff">
        <el-menu-item index="/">
        ...
        <el-menu-item index="site-link" @click="openSite">
          <el-icon><Link /></el-icon><template #title>前台</template>
        </el-menu-item>
